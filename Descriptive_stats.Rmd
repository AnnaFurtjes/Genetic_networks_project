...
Note that the vertical lines indicate the quantiles. 
...
This step is done to be able to create the network specific summary statistics, in which multiple regions are combined and weighted according to their PC loadings. 
...
```{r parallel_analysis_graphics, echo=FALSE, out.width = '80%',fig.cap=c("Central Executive","Cingulo-opercular","Default Mode","Whole brain")}
knitr::include_graphics("C:/Users/k1894405/OneDrive - King's College London/PhD/Projects/Genomic SEM project/data_my_own/PA_output/central_exec_PA.png")
knitr::include_graphics("C:/Users/k1894405/OneDrive - King's College London/PhD/Projects/Genomic SEM project/data_my_own/PA_output/cingulo_PA.PNG")
knitr::include_graphics("C:/Users/k1894405/OneDrive - King's College London/PhD/Projects/Genomic SEM project/data_my_own/PA_output/default_mode_PA.PNG")
break
#knitr::include_graphics("C:/Users/k1894405/OneDrive - King's College London/PhD/Projects/Genomic SEM project/data_my_own/PA_output/whole_brain_PA.png")
```
...
volumes<-table$number_included
components<-c(2,2,3,4,2,7,2,2,7,NA);break
