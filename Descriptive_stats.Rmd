...
rm(list=setdiff(ls(),"loadings_pheno_plot"))
library(stringr)
library(data.table)
...
tiff("loadings.tiff", width = 11, height = 6, units = 'in', res=1000)

plot_grid(loadings_pheno_plot,loadings_plot,nrow = 1,ncol = 2,labels=c("A","B"),width=1,height=1, label_size = 18,hjust = 0.07,scale = 0.85)
