...
These genetic correlations include `r nrow(traits_corr_below0)` negative correlations. As you can see in the table below, nearly all negative correlations involve either the frontal pole or the bankssts, which are both known to be difficult to segment, and therefore could potentially index noise (which could explain the negative correlations with more reliably measured brain volumes). 
