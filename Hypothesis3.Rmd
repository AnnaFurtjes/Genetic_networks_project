...
for (i in network_names){
            ...
            factor_model<-paste0("G =~ NA*Matrix+Memory+RT+Symbol Digit+TMTB+Tower+VNR\n\t\t\t\t\t\tG ~~ 1*G \n\t\t\t\t\t\tG ~ ",network_name)
            ...
            indep_model<- paste0("G =~ NA*Matrix+Memory+RT+Symbol Digit+TMTB+Tower+VNR
